...
void FlowView::drawForeground(QPainter *painter, const QRectF &rect){
    tool::Bench::start("FlowView::drawForeground");
    QGraphicsView::drawForeground(painter, rect);
    tool::Bench::stop();
}

void FlowView::drawItems(QPainter *painter, int numItems, QGraphicsItem *items[], const QStyleOptionGraphicsItem options[]){
    tool::Bench::start("FlowView::drawItems");
    QGraphicsView::drawItems(painter, numItems, items, options);
    tool::Bench::stop();
}

void FlowView::paintEvent(QPaintEvent *event){
    tool::Bench::start("FlowView::paintEvent");
